...
export default function Carousel({ item }) {
  ...
  return (
    <div
      className={
        "mt-2 md:mt-14 w-full flex flex-row bg-cover bg-center rounded-lg drop-shadow-lg " +
        classname
      }
    >
      ...
      <div
        ...
        className=" basis-1/6 h-40 md:h-80 justify-center lg:h-96 2xl:h-[32rem] flex items-center bg-[#2e435f] bg-opacity-20 cursor-pointer"
      >
        <CarouselLeftArrow />
      </div>
